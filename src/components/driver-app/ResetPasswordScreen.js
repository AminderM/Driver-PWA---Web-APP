...
const ResetPasswordScreen = () => {
  ...
  const inputCls = 'w-full border py-4 px-4 bg-[#080808] border-[#1F1F1F] text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-[#CC2222]';

  if (status === 'success') return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#030303] px-6 font-['Barlow_Condensed'] text-center">
      <div className="w-20 h-20 bg-[#2DBB62]/20 flex items-center justify-center mb-6">
        <svg className="w-10 h-10 text-[#2DBB62]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#030303] font-['Barlow_Condensed']">
      {/* Header */}
      <div className="pt-16 pb-12 px-6 text-center border-b border-[#1F1F1F]">
        <div className="w-20 h-20 bg-[#CC2222] flex items-center justify-center mx-auto mb-4">
