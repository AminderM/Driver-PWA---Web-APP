    ...
    <div className={`min-h-screen flex flex-col font-['Oxanium'] ${bg}`}>
      ...
      <div className={`px-4 py-4 flex items-center gap-3 border-b ${border}`}>
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center border border-red-600/50 text-red-500 hover:bg-red-600/10 transition-colors relative"
        >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
              ...
              <div className={`border p-4 ${isDark ? 'bg-[#0a0a0a] border-red-600/50' : 'bg-white border-red-400/50'}`}>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-red-600 hover:bg-red-700 disabled:bg-red-600/40 text-white py-3 text-sm tracking-wider transition-colors"
                  >
                    SUBMIT
                  </button>
                </div>
        ...
        <button
          onClick={() => onOpenChat?.(load)}
          className={`w-full py-3 flex items-center justify-center gap-2 border transition-colors tracking-wider text-sm mb-4 ${
            isDark
